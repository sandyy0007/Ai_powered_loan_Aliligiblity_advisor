...
def show_chatbot():
    ...
    Simply answer the questions, and the chatbot will guide you through an interactive experience.
    """)

    # Add some interactive elements
    st.markdown("### 💡 Tips for Better Interaction:")
    st.markdown("- Answer questions honestly for accurate predictions")
    st.markdown("- Use the chat input below to respond")
    st.markdown("- The chatbot will provide personalized advice based on your answers")
                    ...
                    with st.spinner("Thinking..."):
                        try:
                            ...
                            if prediction == 'Y':
                                ...
                                st.markdown("💡 **Next Steps:** Contact your bank to finalize the application process.")
                            else:
                                prediction = 'Not eligible for loan'
                                st.markdown("### ☠️ Danger! Your loan application has been **rejected**.")
                                st.markdown("💡 **Improvement Tips:** Consider improving your credit score or increasing your income before reapplying.")
